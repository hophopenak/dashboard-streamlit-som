...
def load_data():
    ...
    # Load file
    gdf = gpd.read_file("D:/semester 7/Project Sains Data/Sumatera.shp")
    df_cluster = pd.read_excel("D:/semester 7/Project Sains Data/hasil_cluster_som.xlsx")
...
sumatera = load_data()
st.write("Kolom tersedia:", sumatera.columns)
